...
main ()
{
  ...
  ofstream precision_out ("precision.out");   // open a "stream" to precision.out
  for (int i = 0; i < max_iterations; i++)
  {
    ...
    precision_out << setprecision (12) << test << "  " << eps  << endl;

  }

  precision_out.close();               // close the output stream
