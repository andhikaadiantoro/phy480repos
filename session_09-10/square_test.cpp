...
double squareit (double x, double y);
...
main (void)
{
  ...
  // }
  // using squareit
  cout << "final y = " << squareit(x,y) << endl;  // prevent optimizing away loop
  gettimeofday (&stop, NULL);      // stop the clock and print elapsed time 
  cout << " Evaluating " << repeat << " x*x's took "
    << elapsed (start, stop) << " seconds" << endl << endl;
  //using the #define
  cout << "final y = " << sqr(x) << endl;  // prevent optimizing away loop
  gettimeofday (&stop, NULL);      // stop the clock and print elapsed time 
  cout << " Evaluating " << repeat << " x*x's took "
    << elapsed (start, stop) << " seconds" << endl << endl;
  //using inline method
  cout << "final y = " << square(x) << endl;  // prevent optimizing away loop
  gettimeofday (&stop, NULL);      // stop the clock and print elapsed time 
  cout << " Evaluating " << repeat << " x*x's took "
    << elapsed (start, stop) << " seconds" << endl << endl;
