...
main (void)
{
  const double lower = -5.;	    // originally -5 // lower limit of integration for uniform
  const double upper = 5.;	    // originally 5 // upper limit of integration for uniform
  const double sigma = 1.;          // constant in gaussian
  const int dim = 10;                // dimension of the integral // originally 1
