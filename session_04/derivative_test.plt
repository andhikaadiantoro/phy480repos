...
plot "derivative_test.dat" using ($1):($2) title 'forward difference', "derivative_test.dat" using ($1):($3) title 'central difference', "derivative_test.dat" using ($1):($4) title 'extrapolated difference',  \
