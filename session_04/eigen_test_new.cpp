...
main () 
{ 
  ofstream out ("eigen_test_new.dat");
  for(int i=250; i <= 400 ; i+=5){


  clock_t start, end;		// start and stop times 
  int dimension = i;		// dimension of the matrices and vectors 
  ...
  out << scientific << setprecision (8) << log10(dimension) << " " << log10((double) (end - start)) << endl;
